...
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://Surajbot:surajbot@surajbot.qv1brhu.mongodb.net/?retryWrites=true&w=majority")
SUPPORT_GRP = getenv("SUPPORT_GRP", "quizbysu")
UPDATE_CHNL = getenv("UPDATE_CHNL", "quizbys")
MUSIC = getenv("MUSIC", "musuchatbot")
REPO = getenv("REPO", " https://github.com/SURAJSAINI93/RADHIKA")
